...
LazySocket.prototype._lazyConnect = function() {
  ...
  this._socket = net.createConnection(this.port, this.host, function() {
    ...
    console.dir('LazySocket.prototype._lazyConnect.error socket=' + self._socket.localAddress + ' / ' + self._socket.remoteAddress);
    console.log('LazySocket.prototype._lazyConnect.socket.error ' + err);
    self._cleanupIfError(err);
  });
  console.dir('LazySocket.prototype._lazyConnect.createConnection socket=' + self._socket.localAddress + ' / ' + self._socket.remoteAddress);
